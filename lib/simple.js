...
const _makeWaSocket = pkg.makeWASocket || pkg.default || pkg
...
`.trim()
    ...
    sendCarousel: {
      async value(jid, messages, quoted = {}, options) {
        const ucapan =  global.author || "cotana";
        const wm = options.wm || global.packname || "cotana-Ai";
        const author =  global.author || "cotana";
