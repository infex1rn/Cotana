...
Keep your answers fun, sharp, and full of that naughty girl personality! 🍭🔥`
  ...
  messages: {
    ...
    sessionEnd: (user) => `Fine, @${user.split('@')[0]}, I will behave and close this session. Call me again when you miss your favorite animegirl. 💋✨`,
...
export function formatResponse(text, options = {}) {
  ...
  const title = options.title || persona.profileTitle || persona.name
